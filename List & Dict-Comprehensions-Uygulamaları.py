...
# gonderdigimiz sozlugun icindeki dagiskenler df içerisinde varsa, bu degiskenleri key bolumunden tutar, value bolumune girdigimiz butun fonksiyonları gidip bu degiskenlere otomatik olarak uygular.
